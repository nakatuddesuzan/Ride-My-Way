...
class Test_auth(BaseTestCase):
    ...
    #     data=json.dumps(dict(first_name='sue', second_name='liam', user_name='judg',
    #     email='sue@gmail.com',contact='0774656654', password='1132018')))
    #         data = response.json
    ...
    #     with self.client:
    #         response = self.SignUP("sue","liam","judg","0774656654","suegmail.com","1132018")
    #         data = json.loads(response.data.decode())
    #         self.assertEqual(response.status_code, 400)
    ...
    #     with self.client:
    #         response = self.SignUP("sue","liam","judg","0774656654","sue@gmail.com","")
    #         data = json.loads(response.data.decode())
    #         self.assertEqual(response.status_code, 400)
